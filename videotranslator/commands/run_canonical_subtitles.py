...
def run_canonical_attempt(
    ...
    *,
    ...
    for key, value in (("clean", clean), ("translated", translated), ("integrity", integrity_report), ("speech", speech_report), ("agreement", agreement_report), ("canonical", repaired), ("qa", qa)):
